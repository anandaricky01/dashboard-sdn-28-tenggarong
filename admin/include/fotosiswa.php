                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="edit-foto-siswa&data=<?php echo $nis;?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i></a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data foto <?php echo $nama; ?>?'))window.location.href='foto-siswa&aksi=hapus&data=<?php echo $nis;?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php $no++;}?>
                  </tbody>
