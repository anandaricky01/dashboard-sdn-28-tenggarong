...
<section class="content-header">
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" method="POST" action="konfirmasi-edit-data-guru">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="JAB_GURU_2" name="JAB_GURU_1" value="<?php echo $JAB_GURU_2 ?>">
            </div>
          </div>
          <div class="form-group row">
