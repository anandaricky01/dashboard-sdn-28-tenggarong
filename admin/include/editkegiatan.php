<?php 
  ...
  while($data_kegiatan = mysqli_fetch_assoc($query_kegiatan)){
...
<section class="content-header">
  ...
  <div class="card card-info">
    ...
    <form class="form-horizontal" method="POST" action="konfirmasi-edit-kegiatan" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            <input type="text" class="form-control" name="kegiatan" id="nim" value="<?php echo $kegiatan; ?>">
          </div>
        </div>
        <div class="form-group row">
            ...
            <select class="form-control" id="kategori" name="id_kategori_kegiatan">
              ...
              <?php 
                while($data = mysqli_fetch_assoc($query_kategori_kegiatan)){
                  ...
                  $id_kategori_kegiatan_terpilih = $data['id_kategori_kegiatan'];
               ?>
               <?php if ($id_kategori_kegiatan == $id_kategori_kegiatan_terpilih) {
                 ?>
               <option selected value="<?php echo $id_kategori_kegiatan_terpilih; ?>"> <?php echo $kategori_kegiatan; ?></option>
             <?php } else { ?>
              <option value="<?php echo $id_kategori_kegiatan_terpilih; ?>"> <?php echo $kategori_kegiatan; ?></option>
              <?php }} ?>
            </select>
          </div>
        </div>
        ...
        <div class="form-group row">
          <label for="foto" class="col-sm-3 col-form-label">Foto saat ini </label>
          <div class="col-sm-7">
            <img src="../img/<?php echo $foto; ?>" class="img-thumbnail" alt="..." style="width: 100%;">
          </div>
        </div>
        <div class="form-group row">
